...
/// Configuration-only projection, also used in Pure mode. Do not create a
/// manager, initialize a missing sidecar, or start listeners to reserve keys.
pub(crate) fn persisted_shortcuts(
    app_data_dir: &str,
    legacy: Option<&Value>,
