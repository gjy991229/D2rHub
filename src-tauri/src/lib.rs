...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::pet::pet_get_wardrobe,
            commands::pet::pet_wardrobe_action,
            commands::pet::pet_settle_activity,
            commands::pet::pet_open_wardrobe,
            commands::pet::pet_set_menu_open,
