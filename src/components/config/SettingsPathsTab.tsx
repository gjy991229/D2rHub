...
interface SettingsPathsTabProps {
  config: GlobalConfig;
...
function InstallationProfileFields({
  ...
  return (
    <div className="space-y-2 border-t border-border-default/50 pt-3">
      ...
      {isCn && (
        <>
          ...
          <div className="flex gap-2">
            <input type="text" value={config.cn_battle_net_path} readOnly className="flex-1 h-8 px-3 rounded-lg bg-surface-hover text-xs border border-border-default text-text-primary" />
      ...
      <div className="flex gap-2">
        <input type="text" value={config[fields.game]} readOnly className="flex-1 h-8 px-3 rounded-lg bg-surface-hover text-xs border border-border-default text-text-primary" />
      ...
      <div className="flex gap-2">
        <input type="text" value={config[fields.savedGames]} readOnly className="flex-1 h-8 px-3 rounded-lg bg-surface-hover text-xs border border-border-default text-text-primary" />
...
export function SettingsPathsTab({
  config,
  settingsAvailable,
  detectedPaths,
  updateConfig,
      ...
      <div className="spatial-panel p-3 space-y-2">
        ...
        {([
          ...
          <div className="space-y-2" key={field}>
            ...
            <div className="flex gap-2">
              <input type="text" value={config[field]} readOnly className="flex-1 h-8 px-3 rounded-lg bg-surface-hover text-xs border border-border-default text-text-primary" />
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            <input type="text" value={config.browser_path} readOnly className="flex-1 h-8 px-3 rounded-lg bg-surface-hover text-xs border border-border-default text-text-primary" />
