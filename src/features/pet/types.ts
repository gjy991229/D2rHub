...
export interface PetItem {
  ...
  metric?: "seconds" | "days"; target?: number; back?: boolean; motion?: "paws" | "pulse";
}
...
export interface PetWardrobe {
  ...
  seconds: number; days: number; last_day: string; daily_rolls: number;
...
export interface PetReward { id: string; duplicate: boolean; achievement: boolean }
